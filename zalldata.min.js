    ...
    try {
        ...
        "object" != typeof JSON && (JSON = {}), function () {
            ...
            function str(e, t) {
                ...
                switch (d && "object" == typeof d && "function" == typeof d.toJSON && (d = d.toJSON(e)), "function" == typeof rep && (d = rep.call(t, e, d)), typeof d) {
                    ...
                    case"object":
                        ...
                        if (rep && "object" == typeof rep) for (n = rep.length, r = 0; r < n; r += 1) "string" == typeof rep[r] && (s = rep[r], a = str(s, d), a && i.push(quote(s) + (gap ? ": " : ":") + a)); else for (s in d) Object.prototype.hasOwnProperty.call(d, s) && (a = str(s, d), a && i.push(quote(s) + (gap ? ": " : ":") + a));
                        return a = 0 === i.length ? "{}" : gap ? "{\n" + gap + i.join(",\n" + gap) + "\n" + o + "}" : "{" + i.join(",") + "}", gap = o, a
                }
            }
            ...
            "function" != typeof JSON.stringify && (meta = {
                ...
                function walk(e, t) {
                    var r, s, a = e[t];
                    if (a && "object" == typeof a) for (r in a) Object.prototype.hasOwnProperty.call(a, r) && (s = walk(a, r), void 0 !== s ? a[r] = s : delete a[r]);
            ...
            var e = Array.prototype, t = Function.prototype, r = Object.prototype, s = e.slice, a = r.toString,
                n = r.hasOwnProperty, i = (t.bind, e.forEach), o = (e.indexOf, Array.isArray), d = {},
                c = _.each = function (e, t, r) {
                    if (null == e) return !1;
                    if (i && e.forEach === i) e.forEach(t, r); else if (e.length === +e.length) {
                        for (var s = 0, a = e.length; s < a; s++) if (s in e && t.call(r, e[s], s, e) === d) return !1
                    } else for (var o in e) if (n.call(e, o) && t.call(r, e[o], o, e) === d) return !1
                };
            _.extend = function (e) {
                ...
                for (var a = [], n = 0; n < e.length; n++) if (s.call(e, n)) {
                    var i = e[n];
                ...
                return e.length > sd.para.max_string_length ? (sd.log("The string length exceeds the limit. Interception has been made--" + e), e.slice(0, sd.para.max_string_length)) : e
                ...
                _.isObject(e) && (_.each(e, function (t, r) {
                    if (_.isFunction(t)) try {
                        e[r] = t(), _.isFunction(e[r]) && (sd.log("Your property- " + r + "  The format does not meet the requirements, we have removed it"), delete e[r])
                    } catch (s) {
                        delete e[r], sd.log(" Your property- " + r + "   thrown an exception, and we have removed it")
                    }
                ...
                _.isObject(e) && _.each(t, function (t, r) {
                    t in e && (r < 3 ? (delete e[t], sd.log(" Your property- " + t + " is the reserved field, which we have removed")) : sd.log(" Your property- " + t + " is a reserved field, we have removed it is a reserved field, please avoid it as the property name"))
                })
                ...
                return _.isObject(e) ? (_.each(e, function (t, r) {
                    if (_.isArray(t)) {
                        var s = [];
                        _.each(t, function (e) {
                            _.isString(e) ? s.push(e) : sd.log(" Your data-", r, t, " the value in the array must be a string. It has been deleted")
                        }), 0 !== s.length ? e[r] = s : (delete e[r], sd.log(" The empty array has been deleted"))
                    }
                    _.isString(t) || _.isNumber(t) || _.isDate(t) || _.isBoolean(t) || _.isArray(t) || _.isFunction(t) || "$option" === r || (sd.log(" Your data-", r, t, "- The format does not meet the requirements, we have removed it"), delete e[r])
                }), e) : e
                ...
                e = (e + "").replace(/\r\n/g, "\n").replace(/\r/g, "\n");
                var t, r, s, a = "", n = 0;
                for (t = r = 0, n = e.length, s = 0; s < n; s++) {
                    var i = e.charCodeAt(s), o = null;
                    i < 128 ? r++ : o = i > 127 && i < 2048 ? String.fromCharCode(i >> 6 | 192, 63 & i | 128) : String.fromCharCode(i >> 12 | 224, i >> 6 & 63 | 128, 63 & i | 128), null !== o && (r > t && (a += e.substring(t, r)), a += o, t = r = s + 1)
                }
                ...
                e = String(e);
                var t, r, s, a, n, i, o, d, c = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
                    u = 0, p = 0, l = "", f = [];
                if (!e) return e;
                e = _.utf8Encode(e);
                do t = e.charCodeAt(u++), r = e.charCodeAt(u++), s = e.charCodeAt(u++), d = t << 16 | r << 8 | s, a = d >> 18 & 63, n = d >> 12 & 63, i = d >> 6 & 63, o = 63 & d, f[p++] = c.charAt(a) + c.charAt(n) + c.charAt(i) + c.charAt(o); while (u < e.length);
                ...
                var r = "[\\?&]" + t + "=([^&#]*)", s = new RegExp(r), a = s.exec(e);
                ...
                var r = function (r, s, a) {
                    ...
                    if (_.isObject(sd.para.heatmap) && "undefined" == typeof sd.para.heatmap.useCapture && "click" === s && (n = !0), r && r.addEventListener) r.addEventListener(s, function (t) {
                ...
                get: function (e) {
                    ...
                    if (r = null == r ? 73e3 : r, s) {
                        ...
                        "url parse failure" === d && (d = ""), n = d ? "; domain=" + d : ""
                    }
                    if (0 !== r) {
                        var c = new Date;
                ...
                t && "string" == typeof t || (t = "hostname parsing exceptions");
                var r = null;
                try {
                    r = _.URL(e).hostname
                } catch (s) {
                    sd.log("getHostname inferent  url Invalid parameter! ")
                }
                return r || t
                ...
                for (var t = function (e) {
                    ...
                    var i = a[n].indexOf("=");
                    if (i !== -1) {
                        var o = a[n].substring(0, i), d = a[n].substring(i + 1);
                        o = t(o), d = t(d), r[o] = d
                    }
                }
                return r
                ...
                if ("function" == typeof window.URL && s()) t = new URL(e), t.searchParams || (t.searchParams = function () {
                    ...
                    var a = /^https?:\/\/.+/;
                    if (a.test(e) === !1) throw"Invalid URL";
                ...
                switch (typeof t) {
                    case"function":
                        var r = t();
                        return "" === r || "" === _.trim(r) ? "url parse failure" : r.indexOf(".") !== -1 ? r : "url parse failure";
                    case"string":
                        return "" === t || "" === _.trim(t) ? "url parse failure" : t.indexOf(".") !== -1 ? t : "url parse failure";
                    default:
                        var s = _.getCookieTopLevelDomain();
                        return "" === e ? "url parse failure" : "" === s ? "url parse failure" : s
                }
                ...
                if ("string" != typeof e) return sd.log(" transform unicode error ", e), e;
                for (var t = "", r = 0; r < e.length; r++) t += "\\" + e.charCodeAt(r).toString(16);
                return t
            }, _.getReferrer = function (e) {
                var e = e || document.referrer;
                return "string" != typeof e ? " abnormal values_referrer exception  _" + String(e) : (0 === e.indexOf("https://www.baidu.com/") && (e = e.split("?")[0]), e = e.slice(0, sd.para.max_referrer_string_length), "string" == typeof e ? e : "")
                ...
                if (document && "string" == typeof e) {
                    if (0 === e.indexOf("http")) {
                        ...
                        if (_.isEmptyObject(s)) return " Did not take to the value ";
                        var a = null;
                        for (var n in t) if (r === n && "object" == typeof s) if (a = t[n], _.isArray(a)) for (var n = 0; n < a.length; n++) {
                            var i = s[a[n]];
                            if (i) return i
                        } else if (s[a]) return s[a];
                        return " Did not take to the value "
                    }
                    return "" === e ? " Did not take to the value _  Directly open " : " Did not take to the value _  not http   url"
                }
                return " abnormal values_referrer exception  _" + String(e)
            }, _.getReferSearchEngine = function (e) {
                var t = _.getHostname(e);
                if (!t || "hostname parsing exceptions" === t) return "";
                ...
                for (var s in r) for (var a = r[s], n = 0, i = a.length; n < i; n++) if (a[n].test(t)) return s;
                ...
                var t = "(" + sd.para.source_type.utm.join("|") + ")\\=[^&]+", r = sd.para.source_type.search,
                    s = sd.para.source_type.social, a = document.referrer || "", n = _.info.pageProp.url;
                if (n) {
                    var i = n.match(new RegExp(t));
                    return i && i[0] ? "Paid AD traffic" : e(r, a) ? "Natural search traffic" : e(s, a) ? "Social network traffic" : "" === a ? " direct traffic" : "\u5f15\u8350\u6d41\u91cf"
                }
                return "\u83b7\u53d6url exception  "
            }, _.info = {
                initPage: function () {
                    var e = _.getReferrer(), t = location.href, r = _.getCurrentDomain(t);
                    r || sd.debug.jssdkDebug("url_domain exception  _" + t + "_" + r), this.pageProp = {
                        referrer: e,
                        referrer_host: e ? _.getHostname(e) : "",
                        url: t,
                        url_host: _.getHostname(t, "url_host abnormal values"),
                        url_domain: r
                    }
                    ...
                    for (var n in r) (" " + sd.source_channel_standard + " ").indexOf(" " + n + " ") !== -1 ? s[e + n] = r[n] : a[t + n] = r[n];
                    return {$utms: s, otherUtms: a}
                }, properties: function () {
                    return {
                        $timezone_offset:"",
            ...
            var a = {datasend_timeout: 6e3, send_interval: 6e3, one_send_max_length: 6};
            ...
            if ("object" == typeof sd.para.source_type && (sd.para.source_type.utm = _.isArray(sd.para.source_type.utm) ? sd.para.source_type.utm.concat(n) : n, sd.para.source_type.search = _.isArray(sd.para.source_type.search) ? sd.para.source_type.search.concat(i) : i, sd.para.source_type.social = _.isArray(sd.para.source_type.social) ? sd.para.source_type.social.concat(o) : o, sd.para.source_type.keyword = _.isObject(sd.para.source_type.keyword) ? _.extend(d, sd.para.source_type.keyword) : d), _.isObject(sd.para.heatmap) && (sd.para.heatmap.clickmap = sd.para.heatmap.clickmap || "default", sd.para.heatmap.scroll_notice_map = sd.para.heatmap.scroll_notice_map || "default", sd.para.heatmap.scroll_delay_time = sd.para.heatmap.scroll_delay_time || 4e3, sd.para.heatmap.scroll_event_duration = sd.para.heatmap.scroll_event_duration || 18e3, sd.para.heatmap.renderRefreshTime = sd.para.heatmap.renderRefreshTime || 1e3, sd.para.heatmap.loadTimeout = sd.para.heatmap.loadTimeout || 1e3), "object" == typeof sd.para.server_url && sd.para.server_url.length) for (s = 0; s < sd.para.server_url.length; s++) /sa\.gif[^\/]*$/.test(sd.para.server_url[s]) || (sd.para.server_url[s] = sd.para.server_url[s].replace(/\/sa$/, "/sa.gif").replace(/(\/sa)(\?[^\/]+)$/, "/sa.gif$2")); else /sa\.gif[^\/]*$/.test(sd.para.server_url) || (sd.para.server_url = sd.para.server_url.replace(/\/sa$/, "/sa.gif").replace(/(\/sa)(\?[^\/]+)$/, "/sa.gif$2"));
            ...
            state: 0,
            historyState: [],
            stateType: {1: "1-init NotStarted ", 2: "2-init start ", 3: "3-store  finish  "},
            getState: function () {
            ...
            sd._t = sd._t || 1 * new Date, sd.lib_version = "1.15.13", sd.is_first_visitor = !1, sd.source_channel_standard = "utm_source utm_medium utm_campaign utm_content utm_term"
        }, sd.log = function () {
            ...
            distinct_id: function () {
                ...
                var t = "app_h5 through failure -", r = {
                    1: t + "use_app_track is false",
                    2: t + "Android or iOS no corresponding method is exposed",
                    3.1: t + "Android check server_url fail  ",
                    3.2: t + "iOS check server_url fail  ",
                    4.1: t + "H5  check  iOS server_url  fail  ",
                    4.2: t + "H5  check  Android server_url  fail  "
                }, s = e.output, a = e.step, n = e.data || "";
                ...
                var t = {
                    1: {
                        title: " The current page cannot be visualized  ",
                        message: "App SDK  and  Web JS SDK  No opening is made, please contact your technician for correction   App SDK     See the documentation for configuration details.   ",
                        link_text: " The configuration document   ",
                        link_url: "https://manual.sensorsdata.cn/sa/latest/tech_sdk_client_link-1573913.html"
                    },
                    2: {
                        title: " The current page cannot be visualized  ",
                        message: "App SDK  and  Web JS SDK  No opening is made, please contact your technician for correction   Web JS SDK     See the documentation for configuration details.   ",
                        link_text: " The configuration document   ",
                        link_url: "https://manual.sensorsdata.cn/sa/latest/tech_sdk_client_link-1573913.html"
                    },
                    3: {
                        title: " The current page cannot be visualized  ",
                        message: "Web JS SDK  Full embedment configuration is not open, please contact your staff for correction   SDK     See the documentation for configuration details.   ",
                        link_text: " The configuration document   ",
                        link_url: "https://manual.sensorsdata.cn/sa/latest/tech_sdk_client_web_all-1573964.html"
                    },
                    4: {
                        title: " The current page cannot be visualized  ",
                        message: "Web JS SDK  The configuration data  check  address  and  App SDK  The configuration data  check  address   please contact your staff for correction  SDK     See the documentation for configuration details.   ",
                        link_text: " The configuration document   ",
                        link_url: "https://manual.sensorsdata.cn/sa/latest/tech_sdk_client_link-1573913.html"
                    }
                };
        ...
        var commonWays = {
            setOnlineState: function (e) {
                ...
                if (this.autoTrackIsUsed) var a = _.info.pageProp.url; else var a = _.info.pageProp.referrer;
                e = _.isObject(e) ? e : {}, e = _.isObject(e) ? e : {}, sd.is_first_visitor && !e.not_set_profile && (sd.setOnceProfile(_.extend({
                    $first_visit_time: new Date,
                    $first_referrer: _.getReferrer(),
                    $first_browser_language: navigator.language || " abnormal values",
                    $first_browser_charset: "string" == typeof document.charset ? document.charset.toUpperCase() : " abnormal values",
                ...
                for (var a in r) (" " + sd.source_channel_standard + " ").indexOf(" " + a + " ") !== -1 ? s["$" + a] = r[a] : s[a] = r[a];
                ...
                sd.para.is_single_page && _.addHashEvent(function () {
                    var r = _.getReferrer(n);
                    sd.track("$pageview", _.extend({
                        $referrer: r,
                        $url: location.href,
                        $url_path: location.pathname,
                        $title: document.title
                    }, s, e), t), n = location.href
                }), sd.track("$pageview", _.extend({
                ...
                return _.isEmptyObject(sd.store._state) ? "  Please init SDK" : sd.store._state._first_id || sd.store._state.first_id || sd.store._state._distinct_id || sd.store._state.distinct_id
            }, setPlugin: function (e) {
                return !!_.isObject(e) && void _.each(e, function (e, t) {
                    _.isFunction(e) && (_.isObject(window.SensorsDataWebJSSDKPlugin) && window.SensorsDataWebJSSDKPlugin[t] ? e(window.SensorsDataWebJSSDKPlugin[t]) : sd.log(t + "  No access,  Please refer to the documentation and adjust" + t + "     introduce order"))
                })
        ...
        sd.quick = function () {
            ...
            return "string" == typeof t && commonWays[t] ? commonWays[t].apply(commonWays, r) : void ("function" == typeof t ? t.apply(sd, r) : sd.log("quick  There is no such function in the method " + e[0]))
        }, sd.use = function (e, t) {
            _.isObject(sd.modules) && _.isObject(sd.modules[e]) && _.isFunction(sd.modules[e].init) && (t = t || {}, sd.modules[e].init(sd, t))
            ...
            saEvent.check({propertiesMust: e}) && (_.each(e, function (t, r) {
                _.isString(t) ? e[r] = [t] : _.isArray(t) ? e[r] = t : (delete e[r], sd.log("appendProfile   property       value must be a string  or    array"))
            ...
            _.isString(e) && (e = {}, e[s] = 1), saEvent.check({propertiesMust: e}) && (r(e) ? saEvent.send({
                ...
                properties: e
            }, t) : sd.log("profile_increment     values can only be numbers"))
            ...
            _.isString(e) && (e = [], e.push(r)), _.isArray(e) ? (_.each(e, function (e) {
                _.isString(e) ? s[e] = !0 : sd.log("profile_unset       array  the inside value must be string,  filtered out ", e)
            }), saEvent.send({
                type: "profile_unset",
                properties: s
            }, t)) : sd.log("profile_unset     The parameter is   array")
            ...
            } else saEvent.check({distinct_id: e}) ? t === !0 ? r ? store.set("first_id", e) : store.set("distinct_id", e) : r ? store.change("first_id", e) : store.change("distinct_id", e) : sd.log("identify     The argument must be a string  ")
            ...
            saEvent.check({properties: e}) ? _.extend(_.info.currentProps, e) : sd.log("register  Incorrect input parameter  ")
        }, sd.clearAllRegister = function (e) {
            store.clearAllProps(e)
        }, sd.register = function (e) {
            saEvent.check({properties: e}) ? store.setProps(e) : sd.log("register  Incorrect input parameter  ")
        }, sd.registerOnce = function (e) {
            saEvent.check({properties: e}) ? store.setPropsOnce(e) : sd.log("registerOnce  Incorrect input parameter  ")
        }, sd.registerSession = function (e) {
            saEvent.check({properties: e}) ? store.setSessionProps(e) : sd.log("registerSession  Incorrect input parameter  ")
        }, sd.registerSessionOnce = function (e) {
            saEvent.check({properties: e}) ? store.setSessionPropsOnce(e) : sd.log("registerSessionOnce  Incorrect input parameter  ")
            ...
            } else sd.log("login     The argument must be a string  "), t && t()
        }, sd.logout = function (e) {
            var t = store.getFirstId();
            if (t) if (store.set("first_id", ""), e === !0) {
                var r = _.UUID();
                store.set("distinct_id", r)
            } else store.set("distinct_id", t); else sd.log("  No first_id logout fail  ")
            ...
            function e() {
                sd.readyState.setState(3), window.sensorsdata_app_call_js = function (e) {
                ...
                }), sd.para.batch_send && sd.batchSend.batchInterval(), sd.store.init(), sd.readyState.setState(4), sd._q && _.isArray(sd._q) && sd._q.length > 0 && _.each(sd._q, function (e) {
            ...
            var t = {
                searchKeywordMatch: location.search.match(/sa-request-id=([^&#]+)/), isSeachHasKeyword: function () {
                    ...
                    sd.para.heatmap_url ? _.loadScript({
                        success: function () {
                            setTimeout(function () {
                                "undefined" != typeof sa_jssdk_heatmap_render && (sa_jssdk_heatmap_render(sd, e, t, r), "object" == typeof console && "function" == typeof console.log && (sd.heatmap_version && sd.heatmap_version === sd.lib_version || console.log("heatmap.js and sensorsdata.js\u7248\u672c\u53f7\u4e0d\u4e00\u81f4 \u53ef\u80fd\u5b58\u5728\u98ce\u9669!")))
                            }, 0)
                        }, error: function () {
                        }, type: "js", url: sd.para.heatmap_url
                    }) : sd.log("    No specifies the HEATmap URL path ")
                ...
                isVtrackMode: !1, loadVtrack: function () {
                    ...
                    return "sa-fe" === e.data.source && void ("v-track-mode" === e.data.type && (e.data.data && e.data.data.isVtrack && (r.isVtrackMode = !0, r.loadVtrack()), window.removeEventListener("message", r.messageListener, !1)))
                }, removeMessageHandle: function () {
                    window.removeEventListener && window.removeEventListener("message", r.messageListener, !1)
                }, verifyVtrackMode: function () {
                    window.addEventListener && window.addEventListener("message", r.messageListener, !1), window.parent && window.parent.postMessage && window.parent.postMessage({
                        source: "sa-web-sdk",
                        type: "v-is-vtrack",
                        data: {}
                    }, "*")
                ...
                if (_.isObject(window.SensorsData_App_Visual_Bridge) && window.SensorsData_App_Visual_Bridge.sensorsdata_visualized_mode && (window.SensorsData_App_Visual_Bridge.sensorsdata_visualized_mode === !0 || window.SensorsData_App_Visual_Bridge.sensorsdata_visualized_mode())) if (_.isObject(sd.para.heatmap) && "default" == sd.para.heatmap.clickmap) if (_.isObject(sd.para.app_js_bridge) && "success" === r.verify_success) if (e) sa_jssdk_app_define_mode(sd, e); else {
                    var s = location.protocol, a = ["http:", "https:"];
            ...
            t.isSeachHasKeyword() ? t.hasKeywordHandle() : window.parent !== self ? (r.verifyVtrackMode(), setTimeout(function () {
                return !r.isVtrackMode && (r.removeMessageHandle(), void (t.isStoregeHasKeyword() ? t.storageHasKeywordHandle() : e()))
            }, 1e3)) : e()
        }, BatchSend.prototype = {
            add: function (e) {
                ...
                if (s > 0) if (s <= r) this.send({
                    keys: e.keys,
                    vals: t
                }); else for (var a = 0; a * r < s; a++) this.send({keys: e.keys.splice(0, r), vals: t.splice(0, r)})
                ...
                for (var e = [], t = [], r = null, s = (new Date).getTime(), a = localStorage.length, n = 0; n < a; n++) {
                    var i = localStorage.key(n);
                    0 === i.indexOf("sawebjssdk-") && /^sawebjssdk\-\d+$/.test(i) && (r = localStorage.getItem(i), r ? (r = _.safeJSONParse(r), r && _.isObject(r) ? (r._flush_time = s, e.push(i), t.push(r)) : (localStorage.removeItem(i), sd.log("localStorage-\u6570\u636eparse exception  " + r))) : (localStorage.removeItem(i), sd.log("localStorage-\u6570\u636e abnormal values" + r)))
                }
        ...
        sd.sendState = sendState, sd.events = new _.eventEmitter, sendState.queue = _.autoExeQueue(), sendState.requestData = null, sendState.getSendCall = function (e, t, r) {
            ...
            if (sd.readyState.state < 3) return sd.log("  Init not finish "), !1;
        ...
        sd.saEvent = saEvent, saEvent.checkOption = {
            ...
            event: function (e) {
                return !(!_.isString(e) || !this.regChecks.regName.test(e)) || (sd.log("   EventName must be a string and a valid variable name. It must not start with a number and only contain: upper and lower case letters, Numbers, underscores, and $  "), !0)
            },
            test_id: "str",
            group_id: "str",
            distinct_id: function (e) {
                return !(!_.isString(e) || !/^.{1,255}$/.test(e)) || (sd.log("distinct_id  Must be a string that cannot be null and is less than 255 bits "), !1)
            }
            ...
            s = sd.para.debug_mode_url.indexOf("?") !== -1 ? sd.para.debug_mode_url + "&data=" + encodeURIComponent(_.base64Encode(e)) : sd.para.debug_mode_url + "?data=" + encodeURIComponent(_.base64Encode(e)), _.ajax({
                ...
                success: function (e) {
                    _.isEmptyObject(e) === !0 ? alert("debug data sent successfully " + r) : alert("debug fail error  reason  " + JSON.stringify(e))
                }
            })
        };
        var store = sd.store = {
            ...
            checkIsAddSign: function (e) {
                ...
                store.setProps(r, !0);
                var a = {};
                if ("" === e && (e = "url parse failure"), _.each(sd.para.preset_properties, function (t, r) {
                    if (r.indexOf("latest_") === -1) return !1;
                    if (r = r.slice(7), t) {
                        if ("utm" !== r && "url parse failure" === e) a["$latest_" + r] = "url domain parse failure"; else if (_.isReferralTraffic(document.referrer)) switch (r) {
                    ...
                    var n = _.info.campaignParamsStandard("$latest_", "_latest_"), i = n.$utms, o = n.otherUtms;
        ...
        sd.bridge = {
            is_verify_success: !1, initPara: function () {
                ...
                "object" == typeof sd.para.app_js_bridge ? sd.para.app_js_bridge = _.extend({}, e, sd.para.app_js_bridge) : sd.para.use_app_track === !0 || sd.para.app_js_bridge === !0 || "only" === sd.para.use_app_track ? (sd.para.use_app_track_is_send !== !1 && "only" !== sd.para.use_app_track || (e.is_send = !1), sd.para.app_js_bridge = _.extend({}, e)) : "mui" === sd.para.use_app_track && (e.is_mui = !0, sd.para.app_js_bridge = _.extend({}, e)), sd.para.app_js_bridge.is_send === !1 && sd.log("\u8bbe\u7f6e\u4e86 is_send:false,\u5982\u679c through failure  \u6570\u636e\u5c06\u88ab\u4e22\u5f03\uff01")
            }, initState: function () {
                function e(e) {
                    function t(e) {
                ...
                if (_.isObject(sd.para.app_js_bridge) && !sd.para.app_js_bridge.is_mui) if (window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers.sensorsdataNativeTracker && window.webkit.messageHandlers.sensorsdataNativeTracker.postMessage && _.isObject(window.SensorsData_iOS_JS_Bridge) && window.SensorsData_iOS_JS_Bridge.sensorsdata_app_server_url) sd.bridge.is_verify_success ? (window.webkit.messageHandlers.sensorsdataNativeTracker.postMessage(JSON.stringify({
                    ...
                    step: "3.1",
                    output: "all"
                }), t.prepareServerUrl()) : "function" == typeof r && r() : (SensorsData_APP_JS_Bridge.sensorsdata_track(JSON.stringify(_.extend({server_url: sd.para.server_url}, e))), "function" == typeof r && r()); else if (!/sensors-verify/.test(navigator.userAgent) && !/sa-sdk-ios/.test(navigator.userAgent) || window.MSStream) _.isObject(sd.para.app_js_bridge) && sd.para.app_js_bridge.is_send === !0 ? (sd.debug.apph5({
                    data: e,
                    step: "2",
                    output: "all"
                ...
                function e(e) {
                    s = e, _.isJSONString(s) && (s = JSON.parse(s)), a && (a(s), a = null, s = null)
                }
        ...
        var heatmap = sd.heatmap = {
            setNotice: function (e) {
                ...
                var n = _.isObject(s) ? s : {}, i = _.isFunction(a) ? a : _.isFunction(s) ? s : void 0;
                ...
                if (d.$element_selector = o ? o : "", sd.para.heatmap && sd.para.heatmap.custom_property) {
                ...
                return !(!_.isObject(sd.para.heatmap) || "default" !== sd.para.heatmap.clickmap) && (!(_.isFunction(sd.para.heatmap.collect_url) && !sd.para.heatmap.collect_url()) && ("all" === sd.para.heatmap.collect_elements ? sd.para.heatmap.collect_elements = "all" : sd.para.heatmap.collect_elements = "interact", void ("all" === sd.para.heatmap.collect_elements ? _.addEvent(document, "click", function (t) {
                    ...
                    if (!s || !s.parentNode || !s.parentNode.children) return !1;
                    var n = s.parentNode;
                    if ("a" === a || "button" === a || "input" === a || "textarea" === a || _.hasAttribute(s, "data-sensors-click")) e.start(r, s, a); else if ("button" === n.tagName.toLowerCase() || "a" === n.tagName.toLowerCase()) e.start(r, n, s.parentNode.tagName.toLowerCase()); else if ("area" === a && "map" === n.tagName.toLowerCase() && _.ry(n).prev().tagName && "img" === _.ry(n).prev().tagName.toLowerCase()) e.start(r, _.ry(n).prev(), _.ry(n).prev().tagName.toLowerCase()); else {
        ...
        sd.init = function (e) {
            return !(sd.readyState && sd.readyState.state && sd.readyState.state >= 2) && (sd.setInitVar(), sd.readyState.setState(2), sd.initPara(e), void sd.detectMode())
        };
        ...
        if (_.each(methods, function (e) {
            ...
            sd[e] = function () {
                if (sd.readyState.state < 3) return _.isArray(sd._q) || (sd._q = []), sd._q.push([e, arguments]), !1;
                {
                    ...
                    try {
                        console.error("  Please init   Sndo JS SDK")
                    } catch (r) {
                        sd.log(r)
                    }
                }
